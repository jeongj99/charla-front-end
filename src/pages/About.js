        ...
        <section className="about-section">
          ...
          <div className="about-us-container">
            <div className="alex-container">
              ...
              <p className="alex-description">
                Lorem ipsum dolor sit amet, te nullam disputationi has, nonumy
                melius assentior eu vel. Qui ei nibh appellantur neglegentur,
                quo magna accusata theophrastus cu. An mei libris equidem. Malis
                blandit his ad, sed ad facer fabellas, id sit epicurei
                consetetur voluptatibus. In vim everti tincidunt contentiones.
                Vix aliquam sanctus ut, ei duo alii facete dolorem. Duo at vide
                nonumy quidam. Nisl mucius ut vix, ei pri regione virtute
                mediocrem. Audire labores offendit usu an. Eu has posse
                maluisset, id eos alii deleniti tincidunt, aperiri reformidans
                vel no. Eu quis voluptua eum, et error convenire has.
              </p>
            </div>
            <div className="jordan-container">
              ...
              <p className="jordan-description">
                Lorem ipsum dolor sit amet, te nullam disputationi has, nonumy
                melius assentior eu vel. Qui ei nibh appellantur neglegentur,
                quo magna accusata theophrastus cu. An mei libris equidem. Malis
                blandit his ad, sed ad facer fabellas, id sit epicurei
